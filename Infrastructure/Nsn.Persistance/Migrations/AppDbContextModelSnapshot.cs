...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nsn.Domain.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nsn.Domain.Entities.Detail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nsn.Domain.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CategoryProduct", b =>
                {
                    b.HasOne("Nsn.Domain.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nsn.Domain.Entities.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nsn.Domain.Entities.Detail", b =>
                {
                    b.HasOne("Nsn.Domain.Entities.Category", "Category")
                        .WithMany("Details")
